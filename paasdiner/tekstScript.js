...
textParser.displayText("Je wordt verdwaast wakker uit een diepe slaap. Aan de geur van kots merk je dat je waarschijnlijk iets te brokko bent gegaan en coma zat te edgen.",1)
player.room.load();
